...
import static com.javajy.sdk.pay.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        try {
            ...
            firstHasDnsErr = true;
            elapsedTimeMillis = WXPayUtil.getCurrentTimestampMs()-startTimestampMs;
            System.out.println("UnknownHostException for domainInfo "+domainInfo);
            WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = WXPayUtil.getCurrentTimestampMs()-startTimestampMs;
            System.out.println("connect timeout happened for domainInfo "+ domainInfo);
            WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = WXPayUtil.getCurrentTimestampMs()-startTimestampMs;
            System.out.println("timeout happened for domainInfo "+ domainInfo);
            WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
